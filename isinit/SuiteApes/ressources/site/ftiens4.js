...
{ 
  ...
  docW = docW + "<tr>" + leftSide + "<td valign=top>"
  if (USEICONS)
      docW = docW + "<a " + fullLink  + " id=\"itemIconLink"+this.id+"\">" + "<img id='itemIcon"+this.id+"' " + "src='"+this.iconSrc+"' border=0 width=16 height=16>" + "</a>"
  else
	  if (this.prependHTML == "")
...
//fonction permetant d'afficher une nouvelle fenetre contenant l'applet
function rechercher()
{
	window.open("./recherche.html","rechercher", "top=50, left=100, screenY=50, screenX=100, width=620, height=620, resizable=no");
}