...
public class RightBottomHandleElement extends HandleElement {

  public RightBottomHandleElement(FElement f, boolean fixe) {
    super(f, fixe);
  }
  ...
  public void drawNewFigureShadow(Graphics g, Color lineColor, int mousePosX, int mousePosY) {
    ...
    if (mousePosX - x < lm)
      ...
      newFigureLargeur = mousePosX - x;
    newFigureY = y;
    if (mousePosY - y < hm)
      newFigureHauteur = hm;
    else
      newFigureHauteur = mousePosY - y;
