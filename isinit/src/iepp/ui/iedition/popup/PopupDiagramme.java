 ...
 * clique droit sur le diagramme d'assemblage
 */
public class PopupDiagramme extends JPopupMenu implements ActionListener
{
	/**
	...
	*/
	 ...
	 */
	public PopupDiagramme(VueDPGraphe diagramme,int clickX, int clickY )
	{
