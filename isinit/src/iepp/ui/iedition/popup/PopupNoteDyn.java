...
/**
 * Crée par Julie TAYAC le 01/02/06: identique à PopupNote.java
 * Classe permettant d'afficher un popupmenu contextuel lorsque l'utilisateur
 * clique avec le bouton droit sur une note du diagramme dynamique
 */

public class PopupNoteDyn extends JPopupMenu implements ActionListener
{
	/**
	 ...
	 * @param note
	 */
	public PopupNoteDyn(VueDPGraphe d,TextCell note)
	{
		this.diagramme = d;
