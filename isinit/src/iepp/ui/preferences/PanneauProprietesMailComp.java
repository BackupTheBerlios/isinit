...
public class PanneauProprietesMailComp extends PanneauOption
{
        ...
        public PanneauProprietesMailComp(String name, IdObjetModele composant)
        {
      ...
      //		 linefeed
          ...
          if(this.composant_choisi!=null)
              this.sLabel.setText(this.composant_choisi.getPaquetagePresentation().getMail());
