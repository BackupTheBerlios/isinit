...
public class PanneauProprietesVerComp extends PanneauOption
{
        ...
        public PanneauProprietesVerComp(String name, IdObjetModele composant)
        {
      ...
      //		 linefeed
          ...
          if(this.composant_choisi!=null)
            this.sLabel.setText(this.composant_choisi.getPaquetagePresentation().getVersion());
