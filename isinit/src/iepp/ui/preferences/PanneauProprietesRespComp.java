...
public class PanneauProprietesRespComp extends PanneauOption
{
        ...
        public static final String RESPONSABLE_KEY = "ResponsableTitle" ;
        public static final String MAIL_KEY = "MailTitle" ;
        public static final String VERSION_KEY = "VersionTitle" ;

        public PanneauProprietesRespComp(String name, IdObjetModele composant)
        {
      ...
      //		 linefeed
          ...
          if(this.composant_choisi!=null)
            this.sLabel.setText(this.composant_choisi.getPaquetagePresentation().getAuteur());
