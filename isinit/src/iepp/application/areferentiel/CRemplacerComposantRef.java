...
/**
 * Remplacement d'un composant au référentiel.
 */
public class CRemplacerComposantRef extends CommandeNonAnnulable
{

    /**
     * Remplace un composant choisi par l'utilisateur au référentiel.
    ...
    /**
     * Remplace un composant choisi par l'utilisateur au référentiel suivant une version donne et une date fixee.
    ...
    public boolean executer(long idCompASupprimer, String _version, String _datePlacement)
    {
        ...
        // Recuperer le référentiel courant
        ...
        if (id == -3)
        {
            ...
            // Demander au référentiel de retirer l'ancien composant
            try
            {
