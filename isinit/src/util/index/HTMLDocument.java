...
public class HTMLDocument
{
    ...
    public static Document Document(File f) throws IOException, InterruptedException
    {
        ...
        String url =  ToolKit.getRelativePathOfAbsolutePath(f.getAbsolutePath(),GenerationManager.getInstance().getCheminGeneration());
        url = url.replace(dirSep, '/');
        url = ToolKit.removeSlashTerminatedPath(url);
